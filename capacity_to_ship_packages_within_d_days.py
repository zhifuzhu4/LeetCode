...
Note:
As for the question "When can we use binary search?", my answer is that,
...
otherwise the conveyor belt couldn't ship the heaviest package. On the other hand,
capacity need not be more thansum(weights), because then we can ship all packages in just one day.
"""
